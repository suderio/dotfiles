...
* Emacs config :TOC_3:
  ...
  - [[#ui][UI]]
    ...
    - [[#editing][Editing]]
  - [[#org][Org]]
    - [[#roamify-everything][Roamify everything?]]
    - [[#org-directories-must-be-set-before-org-loads][Org directories must be set before org loads!]]
    - [[#ui-tweaks][UI Tweaks]]
    - [[#org-level-headers][Org Level Headers]]
    - [[#journal][Journal]]
    - [[#doing-capture][DOING Capture]]
    - [[#workflow][Workflow]]
    - [[#agenda][Agenda]]
    - [[#doing-export][DOING Export]]
    - [[#org-tempo][Org-tempo]]
    - [[#babel][Babel]]
  - [[#magit][Magit]]
  - [[#languages][Languages]]
    ...
    - [[#just][Just]]
    - [[#typst][Typst]]
    - [[#install-treesitter-grammars][Install treesitter grammars]]
    - [[#lsp][LSP]]
  - [[#biblio][Biblio]]
  - [[#latex][Latex]]
    - [[#abnt2][ABNT2]]
