...
_G.packer_plugins = {
  ...
  commentary = {
    loaded = true,
    path = "/home/paulo/.local/share/nvim/site/pack/packer/start/commentary",
    url = "https://github.com/tpope/vim-commentary"
  },
  fugitive = {
    loaded = true,
    path = "/home/paulo/.local/share/nvim/site/pack/packer/start/fugitive",
    url = "https://github.com/tpope/vim-fugitive"
  },
  gitgutter = {
    loaded = true,
    path = "/home/paulo/.local/share/nvim/site/pack/packer/start/gitgutter",
    url = "https://github.com/airblade/vim-gitgutter"
  },
  ["hologram.nvim"] = {
    loaded = true,
    path = "/home/paulo/.local/share/nvim/site/pack/packer/start/hologram.nvim",
  ...
  surround = {
    loaded = true,
    path = "/home/paulo/.local/share/nvim/site/pack/packer/start/surround",
